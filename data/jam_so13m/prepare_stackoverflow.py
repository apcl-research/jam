...
so_files = pickle.load(open('stackoverflow_txtfiles.pkl', 'rb'))
...
for partnum in range(0, 20):
    ...
    so_5pt_px = so_files[start_pt:end_pt]

    #for fn in tqdm(so_2pt_px):
        ...
        #with open(f'/dev/shm/funcom/{fid}', 'w') as f:
        #    f.write(fundats[fid])
